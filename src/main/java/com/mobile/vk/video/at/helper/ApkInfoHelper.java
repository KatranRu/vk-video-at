package com.mobile.vk.video.at.helper;
...
import static com.mobile.vk.video.at.helper.DeviceHelper.executeSh;
...
public class ApkInfoHelper {
    ...
    public ApkInfoHelper() {
        String app = ConfigReader.EMULATOR_CONFIG.app(); //читаем путь к apk из пропертей
        ...
        try {
            ...
            apkInfo = executeSh("aapt dumb badging " + ConfigReader.EMULATOR_CONFIG.app());
